...
**A:** 在高清屏（Retina 屏）上，由于设备像素比（DPR）通常是 2 或 3，CSS 中的 1px 实际会被渲染成 2px 或 3px 的物理像素，导致边框看起来很粗，不够精细。
...
// 设置根元素字体大小
document.documentElement.style.fontSize = window.devicePixelRatio * 16 + 'px';
```
...
/* 四周边框 */
.border-all {
  box-shadow: 0 0 0 0.5px #000, inset 0 0 0 0.5px #000;
}
...
- [CSS 像素、物理像素、逻辑像素、设备像素比详解](https://www.zhangxinxu.com/wordpress/2012/08/window-devicepixelratio/)
- [Retina 屏幕下的网页设计](https://www.w3cplus.com/css/towards-retina-web.html)
